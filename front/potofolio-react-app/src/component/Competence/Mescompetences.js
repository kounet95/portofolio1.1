...
export default function Mescompetences() {
    ...
    const handleFrameworkSelect = (framework) => {
        setSelectedFramework(framework.name.trim().toLowerCase()); 
    };

    const filteredCompetences = selectedFramework
  ? state.competences.filter(comp => {
      const frameworkMatch = comp.framework.trim().toLowerCase() === selectedFramework.toLowerCase();
      const languagesMatch = comp.languages.toLowerCase().includes(selectedFramework.toLowerCase());
      
      console.log(`Comparaison: ${comp.framework.trim().toLowerCase()} === ${selectedFramework}`);
      console.log(`Comparaison: ${comp.languages.toLowerCase()} includes ${selectedFramework}`);
      
      
      return frameworkMatch || languagesMatch;
    })
  : state.competences;
    return (
